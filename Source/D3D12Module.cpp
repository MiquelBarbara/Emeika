...
void D3D12Module::loadPipeline() {
    ...
    GetMonitorInfo(MonitorFromWindow(app->getWindowHandle(), MONITOR_DEFAULTTONEAREST), &monitor);
    RECT rect = monitor.rcMonitor;

    DXGI_SWAP_CHAIN_DESC1 swapChainDesc = {};
    swapChainDesc.Width = rect.right - rect.left; // Width of the back buffer in pixels
    swapChainDesc.Height = rect.bottom - rect.top; // Height of the back buffer in pixels
